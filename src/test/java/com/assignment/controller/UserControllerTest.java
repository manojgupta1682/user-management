...
public class UserControllerTest {
	...
	public void getUserByEmail() throws Exception {
		...
		String expected = "{\"result_code\":0,\"result\":\"success\",\"value\":{\"emailId\":\"anilgupta@gmail.com\",\"firstName\":\"anil\",\"lastName\":\"gupta\"}}";
	...
	public void getAllUser() throws Exception {
		...
		System.out.println(result.getResponse().getContentAsString());
		String expected = "{\"result_code\":0,\"result\":\"success\",\"value\":[{\"emailId\":\"anilgupta@gmail.com\",\"firstName\":\"anil\",\"lastName\":\"gupta\"},{\"emailId\":\"manojgupta@gmail.com\",\"firstName\":\"manoj\",\"lastName\":\"gupta\"}]}";
	...
	public void deleteUser_whenEmailIsValid_And_UserExists() throws Exception {
		...
		System.out.println(result.getResponse().getContentAsString());
		String expected = "{\"result_code\":0,\"result\":\"success\"}";
	...
	public void loginSuccessfull_whenEmailAndPasswordAreCorrect() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		System.out.println(result.getResponse().getContentAsString());
		String expected = "{\"result_code\":0,\"result\":\"success\",\"value\":\"Welcome Anil Gupta!\"}";
